...
Uuid BLE_ENGINE_RPM_CHARACTERISTIC = Uuid.parse("821B25CA-37A9-4E20-940C-170496C9446D");
...
Uuid BLE_ENGINE_OIL_TEMPERATURE_CHARACTERISTIC = Uuid.parse("A78BE094-4D02-11ED-BDC3-0242AC120002");
...
Uuid BLE_VEHICLE_TIME_SINCE_CODES_CLEARED_CHARACTERISTIC = Uuid.parse("A78BEA42-4D02-11ED-BDC3-0242AC120002");
            
Uuid BLE_VEHICLE_DISTANCE_TRAVELED_WITH_MIL_ON_CHARACTERISTIC = Uuid.parse("A78BEB84-4D02-11ED-BDC3-0242AC120002");
            
Uuid BLE_VEHICLE_DISTANCE_TRAVELED_SINCE_CODES_CLEARED_CHARACTERISTIC = Uuid.parse("A78BEA44-4D02-11ED-BDC3-0242AC120002");
            

List<Uuid> deviceServices = [BLE_SERVICE_ENGINE_UUID,BLE_SERVICE_VEHICLE_UUID,];
const String DEVICE_NAME = "ESP32-OBD2-BLE";
enum BleOBDCheckList {engineRpmCharacteristic,engineSpeedMeterCharacteristic,engineAirIntakeTempCharacteristic,engineLoadCharacteristic,engineCoolantTemperatureCharacteristic,engineOilTemperatureCharacteristic,vehicleSpeedCharacteristic,vehicleTimeRunWithMilOnCharacteristic,vehicleTimeSinceCodesClearedCharacteristic,vehicleDistanceTraveledWithMilOnCharacteristic,vehicleDistanceTraveledSinceCodesClearedCharacteristic}
List<Uuid> deviceCharacteristic = [BLE_ENGINE_RPM_CHARACTERISTIC,BLE_ENGINE_SPEED_METER_CHARACTERISTIC,BLE_ENGINE_AIR_INTAKE_TEMP_CHARACTERISTIC,BLE_ENGINE_LOAD_CHARACTERISTIC,BLE_ENGINE_COOLANT_TEMPERATURE_CHARACTERISTIC,BLE_ENGINE_OIL_TEMPERATURE_CHARACTERISTIC,BLE_VEHICLE_SPEED_CHARACTERISTIC,BLE_VEHICLE_TIME_RUN_WITH_MIL_ON_CHARACTERISTIC,BLE_VEHICLE_TIME_SINCE_CODES_CLEARED_CHARACTERISTIC,BLE_VEHICLE_DISTANCE_TRAVELED_WITH_MIL_ON_CHARACTERISTIC,BLE_VEHICLE_DISTANCE_TRAVELED_SINCE_CODES_CLEARED_CHARACTERISTIC,];
    BleOBDCheckList getOBDEnmum(Uuid characteristicId) {
        ...
        if (characteristicId == BLE_VEHICLE_DISTANCE_TRAVELED_WITH_MIL_ON_CHARACTERISTIC) {
            return BleOBDCheckList.vehicleDistanceTraveledWithMilOnCharacteristic;
        }
        

        if (characteristicId == BLE_VEHICLE_DISTANCE_TRAVELED_SINCE_CODES_CLEARED_CHARACTERISTIC) {
            return BleOBDCheckList.vehicleDistanceTraveledSinceCodesClearedCharacteristic;
        }
